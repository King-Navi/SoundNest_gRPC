...
def override_dependencies():
    ...
    # Wirea módulo donde se usen Provide[] (esto actualiza FastAPI)
    container.wire(modules=["src.utils.rest_api"])

    app.container = container  # opcional pero útil si usas `.container` en tests
